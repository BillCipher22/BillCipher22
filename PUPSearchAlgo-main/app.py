...
def index():
    ...
    if request.method == "POST":
        try:
            ...
            return render_template("index.html", result=result, search_type=search_type, execution_time=execution_time,
                                   test_data=test_data)
        except ValueError:
    ...
    return render_template("index.html", test_data=test_data, array=array)
